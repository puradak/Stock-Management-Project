...
public class ShowStock extends JFrame implements BasicGUI{
	...
	public void printGUI() { 
		...
		lb_name.setFont(new Font("굴림", Font.PLAIN, 16));
		...
		lb_price_t.setFont(new Font("굴림", Font.PLAIN, 16));
		...
		price_t.setFont(new Font("굴림", Font.PLAIN, 16));
		...
		lb_price_y.setFont(new Font("굴림", Font.PLAIN, 16));
		...
		price_y.setFont(new Font("굴림", Font.PLAIN, 16));
		...
		lb_change.setFont(new Font("굴림", Font.PLAIN, 16));
		...
		change.setFont(new Font("굴림", Font.PLAIN, 16));
		...
		lb_wealth.setFont(new Font("굴림", Font.PLAIN, 16));
		...
		wealth.setFont(new Font("굴림", Font.PLAIN, 16));
		...
		JButton btn_ok2 = new JButton("검색하기");
		...
		btn_ok2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					name.setText(stock.getName());
					price_t.setText(stock.getPrice_t()+"원");
					price_y.setText(stock.getPrice_y()+"원");
					change.setText(stock.getNetChange()+"%");
					asset.setText(""+stock.getAsset()+"주");
